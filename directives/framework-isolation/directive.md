...
description: >
  The domain's shape comes from the domain, never from annotations, DTOs, persistence or transport objects. Framework
  code adapts around the domain, not the other way round.
