...
description: >
  Functional constructs replace null checks and manual loops when they read better — clarity is the test, not novelty.
  The named types (Optional, Stream) are JVM-flavored; the underlying idea generalizes to any language with the
