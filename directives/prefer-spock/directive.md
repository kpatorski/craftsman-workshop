...
Introduces no new fields — see [core.md](../../../craftsman/plugins/craftsman/core.md). `enabled-by-default: false` because this names a concrete library, not an agnostic rule — see core.md, "Fields specific to `directive`".
