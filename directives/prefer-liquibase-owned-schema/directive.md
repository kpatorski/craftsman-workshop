...
Introduces no new fields — see [core.md](../../../craftsman/plugins/craftsman/core.md). `enabled-by-default: false` because this names concrete infrastructure — see core.md, "Fields specific to `directive`".
