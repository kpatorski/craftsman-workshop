...
description: >
  Schema changes are explicit, versioned Liquibase changesets, never inferred by Hibernate at startup. Split out from
  the old `default-stack` reference so it can be toggled independently of the rest of the JVM stack.
