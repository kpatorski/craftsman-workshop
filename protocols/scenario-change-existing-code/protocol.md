...
6. [tdd-loop](../tdd-loop/protocol.md) — extend the suite and the production code, with the overrides above applied to its `enumerate-test-cases` and `decide-test-level` steps.
