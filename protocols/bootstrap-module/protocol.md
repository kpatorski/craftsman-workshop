...
description: >
  Sets up a new module from nothing — stack, build, package skeleton, baseline configuration — and ends ready to build its first use case.
...
steps: [choose-stack, create-build, add-dependencies, scaffold-package-skeleton, base-configuration, pick-first-aggregate]
