...
steps: [restate-understanding, event-storming-loop, propose-candidate-specs, detail-spec, collect-open-questions,
  finalize]
done-when: >
...
2. [event-storming-loop](../../bundles/event-storming/protocols/event-storming-loop/protocol.md)
