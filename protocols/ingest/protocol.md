...
output: >
  the raw input text, plus the digested rules if a business-rules.md was found, with sources recorded for the session
  file
---
...
3. A found `business-rules.md`'s Given/When/Then rules are authoritative input for the rest of the loop — carry them
   through as-is, do not re-derive them from the raw text.
